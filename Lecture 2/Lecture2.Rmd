...
```{r, Quiz1O, echo = FALSE}
actionButton("refreshQ1", "Refresh")
plotOutput("Q1")
```
...
```{r, Quiz2O, echo = FALSE}
actionButton("refreshQ2", "Refresh")
plotOutput("Q2")
```
...
```{r, Quiz3O, echo = FALSE}
actionButton("refreshQ3", "Refresh")
plotOutput("Q3")
```
...
```{r, Quiz4O, echo = FALSE}
actionButton("refreshQ4", "Refresh")
plotOutput("Q4")
```
...
```{r, Quiz5O, echo = FALSE}
actionButton("refreshQ5", "Refresh")
plotOutput("Q5")
```
